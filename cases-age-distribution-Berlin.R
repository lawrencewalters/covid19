...
dates <- c("2020-03-11","2020-03-18","2020-03-30")
...
ggplot(df[order(df$date),],
  ...
  geom_bar(stat = 'identity', colour = "black", 
           position="dodge2") + #position_dodge(width = NULL, preserve = "total")) +
  scale_y_continuous("Percent of Total Caess") +
  ...
  labs(title = "Berlin age distribution over time",
       ...
       caption = "Sources: berlin.de (Berlin)")
